...
**Live URLs:**
- https://five-mp-conservation-effort.exe.xyz:8000/?pwd=test2026
- https://fivemp-testing.exe.xyz:8000/?pwd=test2026 (larger dataset)
...
curl "http://localhost:8000/api/parks/COD_Virunga/stats?pwd=test2026" | jq '.deforestation'

# Enhanced fire narrative
curl "http://localhost:8000/api/parks/COD_Virunga/fire-narrative?pwd=test2026" | jq '.hotspots[:2], .trend'

# Deforestation with trends
curl "http://localhost:8000/api/parks/COD_Virunga/deforestation-narrative?pwd=test2026" | jq '.trend_direction'

# Settlement narrative
curl "http://localhost:8000/api/parks/COD_Virunga/settlement-narrative?pwd=test2026" | jq '.conflict_risk'
```
...
- **Local:** http://localhost:8000/?pwd=test2026
- **Production:** https://five-mp-conservation-effort.exe.xyz:8000/?pwd=test2026
- **Passwords:** test2026, REDACTED_PWD, REDACTED_PWD
