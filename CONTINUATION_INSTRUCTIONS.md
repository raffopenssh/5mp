...
### 1. Globe Navigation
- [ ] Load globe at https://five-mp-conservation-effort.exe.xyz:8000/?pwd=test2026
...
```bash
# Fire narrative
curl -s "http://localhost:8000/api/parks/COD_Virunga/fire-narrative?pwd=test2026" | python3 -m json.tool | head -30

# Deforestation narrative  
curl -s "http://localhost:8000/api/parks/COD_Virunga/deforestation-narrative?pwd=test2026" | python3 -m json.tool | head -30

# Settlement narrative
curl -s "http://localhost:8000/api/parks/COD_Virunga/settlement-narrative?pwd=test2026" | python3 -m json.tool | head -30
```
...
- [ ] Enter "test2026" - redirects to globe
