...
```bash
# Fire narrative
curl -s "http://localhost:8000/api/parks/COD_Virunga/fire-narrative?pwd=test2026" | jq

# Deforestation narrative
curl -s "http://localhost:8000/api/parks/COD_Virunga/deforestation-narrative?pwd=test2026" | jq

# Settlement narrative
curl -s "http://localhost:8000/api/parks/COD_Virunga/settlement-narrative?pwd=test2026" | jq

# Park stats
curl -s "http://localhost:8000/api/parks/COD_Virunga/stats?pwd=test2026" | jq
```
