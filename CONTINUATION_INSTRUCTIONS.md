...
curl "http://localhost:8000/api/parks/COD_Virunga/fire-narrative?pwd=test2026&year=2022"

# Deforestation with date range
curl "http://localhost:8000/api/parks/COD_Virunga/deforestation-narrative?pwd=test2026&from=2018-01-01&to=2022-12-31"
...
- **This VM:** https://fivemp-testing.exe.xyz:8000/?pwd=test2026 (primary data)
- **Other VM:** https://five-mp-conservation-effort.exe.xyz:8000/?pwd=test2026
