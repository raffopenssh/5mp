...
### Test Narrative APIs
```bash
curl -s --cookie "access_pwd=test2026" "http://localhost:8000/api/parks/CAF_Chinko/fire-narrative" | python3 -m json.tool
curl -s --cookie "access_pwd=test2026" "http://localhost:8000/api/parks/CAF_Chinko/deforestation-narrative" | python3 -m json.tool
```
...
## URLs
- App: https://fivemp-testing.exe.xyz:8000/?pwd=test2026
