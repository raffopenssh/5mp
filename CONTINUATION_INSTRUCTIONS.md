...
- **App password:** test2026, REDACTED_PWD, or REDACTED_PWD
...
Example URL:
```
https://five-mp-conservation-effort.exe.xyz:8000/?pwd=test2026&lat=-2.5&lng=35.1&z=8&from=2023-01-01&to=2025-12-31&pa=TZA_Serengeti
```
...
- **Other VM:** https://fivemp-testing.exe.xyz:8000/?pwd=test2026 (more data)
- **Login:** https://five-mp-conservation-effort.exe.xyz:8000/login
...
```bash
# Park stats
curl "http://localhost:8000/api/parks/TZA_Serengeti/stats?pwd=test2026"

# Fire narrative
curl "http://localhost:8000/api/parks/COD_Virunga/fire-narrative?pwd=test2026&year=2023"

# Deforestation narrative  
curl "http://localhost:8000/api/parks/COD_Virunga/deforestation-narrative?pwd=test2026&from=2018-01-01&to=2023-12-31"

# Settlement narrative
curl "http://localhost:8000/api/parks/COD_Virunga/settlement-narrative?pwd=test2026"

# Export parks CSV
curl "http://localhost:8000/api/export/parks?pwd=test2026"
```
