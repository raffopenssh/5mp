...
curl "http://localhost:8000/api/parks/COD_Virunga/fire-narrative?pwd=test2026" | jq '.hotspots[:2]'
...
- **Prod:** https://five-mp-conservation-effort.exe.xyz:8000/?pwd=test2026
- **Testing VM:** https://fivemp-testing.exe.xyz:8000/?pwd=test2026 (more data)
...
curl -s "http://localhost:8000/api/parks/COD_Virunga/stats?pwd=test2026" | jq '.deforestation.trend'
```
