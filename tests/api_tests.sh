...
test_api "admin_gpx_logs" "/api/admin/gpx-logs" "303"
test_api "admin_learning_results" "/api/admin/learning-results" "303"
test_api "admin_pending" "/api/admin/pending-approvals" "303"
test_api "admin_learned_features" "/api/admin/learned-features?park_id=CAF_Chinko" "303"
